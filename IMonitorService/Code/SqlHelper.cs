...
namespace IMonitorService.Code
{
    public class SqlHelper
    {
        ...
        private static string connLocal = @"Data Source=10.15.130.78,51433;Initial Catalog=IMonitor;User ID=sa;Password=portal123;Max Pool Size = 512;Connection Timeout=15;";
